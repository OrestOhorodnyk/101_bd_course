...
if __name__ == "__main__":
    ...
    out_file_path = f"{os.getcwd()}/results/lviv_projects.csv"
    ...
    df2 = df1.filter((col('CITY') == 'Lviv') & (col('PROJECT_STATE') != 'On Hold'))
    ...
    # df3.show()
    df4 = df3.groupBy('CUSTOMER_COUNTRY', 'CITY').pivot('YEAR').count().na.fill(0).orderBy('CUSTOMER_COUNTRY')
    df4.show(500)
